        ...
        for(int week=1;week<weeks;week++){
            for(int city=0;city<cities;city++){
                for(int tCity=0;tCity<cities;tCity++){//tCity is city's next level neighbor
                    ...
                    //only reach to week-tCity if week-1--city is already processed
                    if(dp[week-1][city]>-1 &&(tCity==city||flightBetweenCities[city][tCity]==1)){
...
public int maxVacationDaysBackward(int[][] flights, int[][] days) {
    ...
    public static void main(String... args){
        ...
        System.out.println(MaximumVacation.maxVacationDays(cityConnections,cityVac));
