...
public class FindOddFrequentNumber {
    //an array contains number occurs mostly even times, except one that occurs odd times, preorderFind that numbers
    //XOR the elements in array to preorderFind that number appears odd times
